...
namespace TM.Core.Migrations
{
    ...
    [Migration("20241020170459_V22_Migration")]
    partial class V22_Migration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TM.Core.Entity.Todo", b =>
                {
                    ...
                    b.Property<int?>("UserPKUserId")
                        .HasColumnType("int");

                    b.HasKey("PKTodoId");

                    b.HasIndex("UserPKUserId");
            ...
            modelBuilder.Entity("TM.Core.Entity.Todo", b =>
                {
                    b.HasOne("TM.Core.Entity.User", null)
                        .WithMany("Todos")
                        .HasForeignKey("UserPKUserId");
                });
